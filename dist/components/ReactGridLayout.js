...
var GridItem_1 = __importDefault(require("./GridItem"));
var RGLPropTypes_1 = __importDefault(require("../RGLPropTypes"));
var fastRGLPropsEqual_1 = require("../fastRGLPropsEqual");
// End Types
 ...
 */
var ReactGridLayout = /** @class */ (function (_super) {
    __extends(ReactGridLayout, _super);
    function ReactGridLayout() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = {
            activeDrag: undefined,
            layout: (0, coreUtils_1.synchronizeLayoutWithChildren)(_this.props.layout, _this.props.children, _this.props.cols, 
            // Legacy support for verticalCompact: false
            (0, coreUtils_1.compactType)(_this.props), _this.props.allowOverlap),
            mounted: false,
            oldDragItem: null,
            oldLayout: null,
            oldResizeItem: null,
        ...
        _this.onDragStart = function (i, x, y, _a) {
            ...
            var l = (0, coreUtils_1.getLayoutItem)(layout, i);
            if (!l)
                return;
            _this.setState({
                oldDragItem: (0, coreUtils_1.cloneLayoutItem)(l),
                oldLayout: layout
            });
        ...
        _this.onDrag = function (i, x, y, _a) {
            ...
            layout = (0, coreUtils_1.moveElement)(layout, l, x, y, isUserAction, preventCollision, (_b = (0, coreUtils_1.compactType)(_this.props)) !== null && _b !== void 0 ? _b : fallbackCompactType, cols, allowOverlap);
            _this.props.onDrag(layout, oldDragItem, l, placeholder, e, node);
            _this.setState({
                layout: allowOverlap
                    ? layout
                    : (0, coreUtils_1.compact)(layout, (_c = (0, coreUtils_1.compactType)(_this.props)) !== null && _c !== void 0 ? _c : fallbackCompactType, cols),
        ...
        _this.onResizeStart = function (i, w, h, _a) {
            ...
            if (!l)
                return;
            _this.setState({
                oldResizeItem: (0, coreUtils_1.cloneLayoutItem)(l),
        ...
        _this.onResize = function (i, w, h, _a) {
            ...
            var _d = _this.props, cols = _d.cols, preventCollision = _d.preventCollision, allowOverlap = _d.allowOverlap;
            var _e = (0, coreUtils_1.withLayoutItem)(layout, i, function (l) {
                // Something like quad tree should be used
                // to find collisions faster
                var hasCollisions;
                if (preventCollision && !allowOverlap) {
                    var collisions = (0, coreUtils_1.getAllCollisions)(layout, __assign(__assign({}, l), { w: w, h: h })).filter(function (layoutItem) { return layoutItem.i !== l.i; });
            ...
            _this.setState({
                layout: allowOverlap
                    ? newLayout
                    : (0, coreUtils_1.compact)(newLayout, (_b = (0, coreUtils_1.compactType)(_this.props)) !== null && _b !== void 0 ? _b : fallbackCompactType, cols),
                activeDrag: placeholder
            });
        };
        _this.onResizeStop = function (i, w, h, _a) {
            ...
            var newLayout = allowOverlap
                ? layout
                : (0, coreUtils_1.compact)(layout, (_b = (0, coreUtils_1.compactType)(_this.props)) !== null && _b !== void 0 ? _b : fallbackCompactType, cols);
            var oldLayout = _this.state.oldLayout;
            _this.setState({
                activeDrag: null,
                layout: newLayout,
        ...
        _this.onDragOver = function (e) {
            ...
            if (!_this.state.droppingDOMNode) {
                ...
                var calculatedPosition = (0, calculateUtils_1.calcXY)(positionParams, 
                // layerY,
                // layerX,
        ...
        _this.removeDroppingPlaceholder = function () {
            ...
            var layout = _this.state.layout;
            var newLayout = (0, coreUtils_1.compact)(layout.filter(function (l) { return l.i !== droppingItem.i; }), (_a = (0, coreUtils_1.compactType)(_this.props)) !== null && _a !== void 0 ? _a : fallbackCompactType, cols);
            _this.setState({
                layout: newLayout,
    ...
    ReactGridLayout.prototype.componentDidMount = function () {
        var _a, _b, _c;
    ...
    ReactGridLayout.getDerivedStateFromProps = function (nextProps, prevState) {
        var newLayoutBase;
        ...
        else if (!(0, coreUtils_1.childrenEqual)(nextProps.children, prevState.children)) {
        ...
        if (newLayoutBase) {
            var newLayout = (0, coreUtils_1.synchronizeLayoutWithChildren)(newLayoutBase, nextProps.children, nextProps.cols, (0, coreUtils_1.compactType)(nextProps), nextProps.allowOverlap);
            return {
                layout: newLayout,
    ...
    ReactGridLayout.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        return (
        // NOTE: this is almost always unequal. Therefore the only way to get better performance
        // from SCU is if the user intentionally memoizes children. If they do, and they can
        // handle changes properly, performance will increase.
        this.props.children !== nextProps.children ||
            !(0, fastRGLPropsEqual_1.fastRGLPropsEqual)(this.props, nextProps) ||
            this.state.activeDrag !== nextState.activeDrag ||
            this.state.mounted !== nextState.mounted ||
            this.state.droppingPosition !== nextState.droppingPosition);
    };
    ReactGridLayout.prototype.componentDidUpdate = function (prevProps, prevState) {
     ...
     */
    ReactGridLayout.prototype.containerHeight = function () {
        if (!this.props.autoSize)
            return;
        var nbRow = (0, coreUtils_1.bottom)(this.state.layout);
    ...
    ReactGridLayout.prototype.onLayoutMaybeChanged = function (newLayout, oldLayout) {
        if (!oldLayout)
     ...
     */
    ReactGridLayout.prototype.placeholder = function () {
     ...
     */
    ReactGridLayout.prototype.processGridItem = function (child, isDroppingItem) {
        if (!child || !child.key)
            return null;
        var l = (0, coreUtils_1.getLayoutItem)(this.state.layout, String(child.key));
        if (!l)
            return null;
    ...
    ReactGridLayout.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: innerRef, className: mergedClassName, style: mergedStyle, onDrop: isDroppable ? this.onDrop : coreUtils_1.noop, onDragLeave: isDroppable ? this.onDragLeave : coreUtils_1.noop, onDragEnter: isDroppable ? this.onDragEnter : coreUtils_1.noop, onDragOver: isDroppable ? this.onDragOver : coreUtils_1.noop },
    ...
    ReactGridLayout.propTypes = RGLPropTypes_1["default"];
    ReactGridLayout.defaultProps = {
        ...
        onDragStart: coreUtils_1.noop,
        onDrag: coreUtils_1.noop,
        onDragStop: coreUtils_1.noop,
        onResizeStart: coreUtils_1.noop,
        onResize: coreUtils_1.noop,
        onResizeStop: coreUtils_1.noop,
        onDrop: coreUtils_1.noop,
